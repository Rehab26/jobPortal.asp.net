...
namespace JobPortal.App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(DbContext ctx, ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManagerFactory authenticationManagerFactory, IUnitOfWork _uow)
        {
        ...
        public ApplicationUserManager UserManager
        {
            get
            {
                ...
                var provider = new DpapiDataProtectionProvider("JobPortal");
                _userManager.UserTokenProvider = new DataProtectorTokenProvider<User, string>(provider.Create("EmailConfirmation"))
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user.UserType == UserType.Company && result == SignInStatus.Success)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.RegisterCompanyViewModel != null)
                    {
                        ...
                        user.UserType = JobPortal.Models.Enums.UserType.Company;
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            UserManager.EmailService = new EmailService();      //the email service was not hit until i added this

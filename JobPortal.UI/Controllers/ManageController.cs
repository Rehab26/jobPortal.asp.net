...
namespace JobPortal.UI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(UI.App_Start.ApplicationUserManager userManager, UI.App_Start.ApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ...
            return View(new ManageLoginsViewModel
            {
                ...
                OtherLogins = (IList<Microsoft.AspNetCore.Http.Authentication.AuthenticationDescription>)otherLogins
            });
        }
